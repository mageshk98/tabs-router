  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "tracksForHome" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "modulesCount" },
                },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<GetTrackQuery, GetTrackQueryVariables>;
